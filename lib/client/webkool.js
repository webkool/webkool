...
var Application = (function () {
    ...
    Application.prototype.requestWithContext = function (context, url, query, external) {
        ...
        try  {
            ...
            if (static_handlers.hasOwnProperty(context.url) && ((static_handlers[url].hasOwnProperty(method) && (!external || (external && static_handlers[context.url][method].contentType))) || (static_handlers[url].hasOwnProperty('ALL')) && (!external || (external && static_handlers[context.url]['ALL'].contentType)))) {
